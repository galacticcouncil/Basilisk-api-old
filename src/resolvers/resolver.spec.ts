...
describe('Resolver tests', function () {
    ...
    it('can compute chunk size', function () {
        expect(
            getChunkSizeInSeconds('2021-11-11T10:00', '2021-11-11T11:00', 60)
        ).toStrictEqual(60);
        expect(
            getChunkSizeInSeconds('2021-11-11T10:00', '2021-11-11T11:00', 10)
        ).toStrictEqual(360);
        expect(
    ...
    it('can fetch 6 points 10 minutes apart', async () => {
        await client.test(
            `
        query {
    ...
    it('can fetch 10 points over time', async () => {
        await client.test(
            `
        query {
    ...
    it('can fetch 4 hourly points ', async () => {
        await client.test(
            `
        query {
    ...
    it('can fetch 4 hourly points for pool id 1', async () => {
        await client.test(
            `
        query {
